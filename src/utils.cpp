...
Vertex operator + (const Vertex &v1, const Vertex &v2)
{
	...
	tmp.tex_coord.u=v1.tex_coord.u+v2.tex_coord.u;
	tmp.tex_coord.v=v1.tex_coord.v+v2.tex_coord.v;
	tmp.tex_id=v1.tex_id;
...
Vertex operator * (double c, const Vertex &v2)
{
	...
	tmp.tex_coord.u=c*v2.tex_coord.u;
	tmp.tex_coord.v=c*v2.tex_coord.v;
	tmp.tex_id=v2.tex_id;
